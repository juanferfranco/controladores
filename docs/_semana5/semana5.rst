Semana 5: Unidad 2/Reto 2
==========================

Esta semana vamos a construir finalmente el computador.

Propósito de aprendizaje
--------------------------
Comprender cómo funciona y organiza un computador mediante
la construcción de un circuito lógico que implemente el conjunto
de instrucciones de una unidad de procesamiento de 16 bits y
conectarlo a los circuitos necesarios para configurar un computador
completo. 
...
Actividad 1
^^^^^^^^^^^^
* Fecha: agosto 4 de 2020 - 8 a.m.
* Descripción: encuentro sincrónico para compartir y discutir 
  los resultados del reto 1 de la Unidad 2.
...
Actividad 5
^^^^^^^^^^^^
* Fecha: agosto 6 a agosto 11 de 2020.
...
¿Qué debes entregar?
^^^^^^^^^^^^^^^^^^^^^
* Crea una carpeta que llamarás reto5.
* Guarda todos los archivos del project5 en esa carpeta.
...
* Guarda en la carpeta una copia de la `rúbrica <https://docs.google.com/spreadsheets/d/1nu0VLavLFgPH7MEHEMAioaKGccbt90joZ0Om8fwY_Gc/edit?usp=sharing>`__
...
* Comprime la carpeta principal en formato .ZIP, ojo, solo .ZIP no uses otros
  formatos por favor.
* Entrega el archivo .ZIP `aquí <https://auladigital.upb.edu.co/mod/assign/view.php?id=615875>`__.
