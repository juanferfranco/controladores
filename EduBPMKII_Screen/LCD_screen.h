...
public:
    ...
    virtual void dBitmap(uint16_t x, uint16_t y, const uint16_t *image, int16_t w, int16_t h);
    virtual void dBitmap8(uint16_t x, uint16_t y, const uint8_t *image, int16_t w, int16_t h);
...
protected:
    ...
    virtual void _writebitMap(const uint8_t *image, int16_t size) =0;
